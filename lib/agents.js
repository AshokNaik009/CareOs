...
// ElevenLabs requires flash/turbo v2 for English agents and a multilingual model otherwise. Arabic uses
// v3 Conversational: it infers vowels from context better (flash v2.5 read حجزت as "hijzat").
const TTS_MODEL = { en: 'eleven_flash_v2', ar: 'eleven_v3_conversational' };
...
module.exports = {
  ...
  PROMPT, FIRST_MESSAGE, TOOLS, AGENT_SPECS, VOICES, AR_VOICE, TTS_MODEL, arabicPrompt, arabicFirstMessage, arabicAddressRule,
};
